...
private let reuseIdentifier = "FriendPhotoCollectionViewCellId"
...
class FriendPhotosCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return friendPhotosNames.count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let image = selectedModel!.friendPhotosName[indexPath.row]
        cell.friendPhoto.frame = CGRect(x: 0, y: 0, width: 100, height: 100)
