...
class CommunitiesAllTableViewController: UITableViewController {
    ...
    private func generateCommunitiesAll() {
        ...
        let community6 = Community(communityImageName: "com6", communityName: "Community 6", isAdded: false)
        let community7 = Community(communityImageName: "com7", communityName: "Community 7", isAdded: false)
        let community8 = Community(communityImageName: "com8", communityName: "Community 8", isAdded: false)
        let community9 = Community(communityImageName: "com9", communityName: "Community 9", isAdded: false)
